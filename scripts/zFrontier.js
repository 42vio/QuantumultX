const $ = new Env('zFrontier')
const CookieKey = "zFrontierCookie";
...
async function checkin() {
  const myRequest = {
    url: `https://api.zfrontier.com/app/signIn`,
    headers: {
        'x-zfuser-token' : cookie
    }
  }
...
function GetCookie() {
    ...
    var tmpCookie = $.getdata(CookieKey); 
    if (CookieValue) {
        if (CookieValue != tmpCookie) {
